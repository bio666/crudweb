              ...
              <div class="col-lg-12" style="background-image: url(/*../../media/images/background/bg1.png*/);background-position: center;background-repeat: no-repeat;background-size: 112%;">
                ...
                <div class="p-5">
                  ...
                  <form action="" method="post" class="user">
                    <div class="form-group">
                      <input type="text" name="user" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="User"required>
                    </div>
                    <div class="form-group">
                ...
                <?php
                  if (isset($_POST['login'])) {
                    ...
                    $alert = mysqli_query($koneksi, "SELECT * FROM tb_joki WHERE user = '".$_POST['user']."' AND password = '".$_POST['password']."'");
                    $row = mysqli_fetch_array($alert);
                    $count = mysqli_num_rows($alert);
                    if ($count > 0) {
                      session_start();
                      $_SESSION['nama'] = $row['nama'];
                      $_SESSION['tier_terakhir'] = $row['tier_terakhir'];
                      ...
                      echo '<p style="color:red" align="center"><strong>ERROR!!</strong> User / Password Salah';
                    }
                  }
                ?>
